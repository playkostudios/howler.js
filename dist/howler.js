(() => {
        ...
        Howl2.prototype = {
          ...
          unload: function() {
            ...
            for (i = 0; i < Howler2._howls.length; i++) {
              if (Howler2._howls[i]._src === self._src || !self._isMediaStream && self._src.indexOf(Howler2._howls[i]._src) >= 0) {
                remCache = false;
                break;
              }
            }
          ...
          _refreshBuffer: function(sound) {
            var self = this;
            if (self._isMediaStream) {
              var ua = Howler2._navigator ? Howler2._navigator.userAgent : "";
              ...
              sound._node.bufferSource = Howler2.ctx.createMediaStreamSource(self._src);
            } else {
  ...
  // src/everything.js
  var import_howler = __toESM(require_howler_core());
